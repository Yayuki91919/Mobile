              ...
              <div class="card-body px-5 py-5">
                ...
                <form action="" method="post">
                  ...
                  <div class="form-group">
                    <label>Email *</label>
                    <input type="email" name="email" class="form-control p_input" value="<?php echo $email; ?>" required>
                    <span class="error" style="color:red; font-size:12px"><?php echo $emailErr; ?></span>
                  </div>
                  <div class="form-group">
                    <label>Password *</label>
                    <input type="password" name="password" class="form-control p_input" value="<?php echo $password; ?>" required>
